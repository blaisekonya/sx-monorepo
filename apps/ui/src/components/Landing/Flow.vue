...
const STEPS = [
  {
    title: 'Join',
    about:
      'Prove your personhood, set up your UBI stream, and discuss issues of human survival, development and welfare – all while preserving your privacy by default.',
    icon: ISUserPlus
  },
  {
    title: 'Govern',
