...
<template>
  <div
    ...
    <div v-for="i in count" :key="i" class="text-skin-text border rounded-lg block relative overflow-hidden h-[280px]">
      <!-- Cover image -->
      ...
      <div class="relative inline-block mx-4 mt-[34px]">
        <div class="mb-1.5">
          <UiSkeleton class="border-skin-bg rounded-md border-[3px] size-[50px]" />
        </div>
      </div>
