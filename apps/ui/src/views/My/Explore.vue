  ...
  <div>
    <div class="flex justify-between p-4 gap-2 gap-y-3 flex-row">
      <div class="flex flex-row flex-wrap gap-2">
        ...
        <UiSelectDropdown v-if="protocol === 'snapshot'" v-model="category" class="min-h-[46px]" title="Category"
          gap="12" placement="start" :items="categories" />
      </div>
      <UiTooltip title="Create new space">
        <UiButton :to="protocol === 'snapshot'
